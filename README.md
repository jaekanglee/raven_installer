...
기본값은 `jaekanglee/raven_installer`의 `v1.0.5` release asset `raven_core-v1.0.5.tar.gz` 입니다.
...
- `RAVEN_RELEASE_TAG`: 설치할 release tag, 기본값 `v1.0.5`
- `RAVEN_RELEASE_ASSET_NAME`: 다운로드할 asset 이름, 기본값 `raven_core-v1.0.5.tar.gz`
